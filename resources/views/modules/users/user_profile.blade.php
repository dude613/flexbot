@extends('layouts.master',[$pageTitle = "Users"] )
                                ...
                                <div class="kt-form__actions">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <button type="button" class="btn btn-success" id="account_update" data-id="">Update</button>&nbsp;
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <button type="button" class="btn btn-success" id="payment_update" data-id="">Update</button>&nbsp;
...
@section('javascript')
    ...
    <script>
        jQuery(document).ready(function () {
            UserDetailsInitialize.init(true);
        });
    </script>
@endsection